...
from schools.models import GradingScale, GradeBoundary, SubjectGradingConfiguration, SubjectRepository
from schools.forms import GradingScaleForm, GradeBoundaryForm, SubjectGradingConfigurationForm
