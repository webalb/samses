...
from schools.models import LevelClasses, ProgramLevelTemplate, Stream, SubjectRepository, SchoolSubject
...
from django import forms
from schools.models import SchoolSubject, SubjectRepository
