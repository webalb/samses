...
from backend.schools.models import School, AcademicSession, Term, Stakeholder, SchoolMetadata, AccreditationStatus, SuspensionClosure, InspectionReport, SchoolMetadata
