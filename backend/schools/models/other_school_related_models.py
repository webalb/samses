...
from backend.student.algorithms import generate_luhn_check_digit
...
class AttendanceSettings(models.Model):
    school = models.OneToOneField(School, on_delete=models.CASCADE, related_name='attendance_settings') 
    attendance_mode = models.CharField(max_length=1, choices=[
        ('1', 'Term End'),
        ('2', 'Daily'),
    ], default='1')
