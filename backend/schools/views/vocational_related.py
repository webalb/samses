...
from backend.schools.forms import VocationalPartnershipForm, DepartmentRepositoryForm, SchoolDepartmentForm
from backend.schools.models import DepartmentRepository, School, VocationalPartnership, SchoolDepartment
