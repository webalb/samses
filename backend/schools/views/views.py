...
from backend.schools.forms import (
    AcademicSessionForm,
    SchoolForm,
    StakeholderForm,
    SubjectForm,
...
from backend.schools.models import (
    AcademicSession,
    Classrooms,
    ComputerLab,
    Laboratory,
...
====================================
"""
from backend.schools.forms import SchoolMetadataForm
from backend.schools.models import SchoolMetadata
@login_required
...
====================================
"""
from backend.schools.models import AccreditationStatus
from backend.schools.forms import AccreditationForm
...
====================================
"""
from backend.schools.models import SuspensionClosure
from backend.schools.forms import SuspensionForm
@login_required
...
====================================
"""
from backend.schools.models import InspectionReport
from backend.schools.forms import InspectionReportForm
@login_required
...
from backend.schools.models import ParentEngagement
from backend.schools.forms import ParentEngagementForm
...
# ||| ATTENDANCE SETTINGS |||
# ===========================
from backend.schools.models import AttendanceSettings

def attendance_settings_view(request, school_id):
    """
    Handles attendance settings for a school.
    """
    school = get_object_or_404(School, pk=school_id)
    
    # Retrieve or create the attendance settings for the school
    attendance_settings, created = AttendanceSettings.objects.get_or_create(school=school)
    
    if request.method == 'POST':
        # Get the selected attendance mode from the form
        attendance_mode = request.POST.get('attendanceMode')
        if attendance_mode in ['1', '2']:
            attendance_settings.attendance_mode = attendance_mode
        ...
        return redirect('schools:attendance_settings', school_id=school.id)

    context = {
        'school': school,
        'attendance_mode': attendance_settings.attendance_mode
    }
    return render(request, 'schools/settings/attendance.html', context)
